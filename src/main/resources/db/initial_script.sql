...
CREATE TABLE IF NOT EXISTS campaign_subscription(id integer, id_campaign integer, id_club_supporter integer, create_at timestamp, update_at timestamp, primary key (id));
